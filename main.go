...
func sayPolo(chatID int64) error {
	...
	res, err := http.Post("https://api.telegram.org/bot1813786957:AAEE_fDJnuL02PLGjElBSd8gAawTxtNGHXA/sendMessage", "application/json", bytes.NewBuffer(reqBytes))
	if err != nil {
		return err
	}
